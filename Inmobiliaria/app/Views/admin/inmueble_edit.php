...
<head>
    ...
    <title>Editar Inmueble — Administrador</title>
...
<body>
    ...
    <main class="main">
        <div class="main__header">
            <h1>Editar Inmueble #<?php echo $inmueble['id_inmueble']; ?></h1>
            <p>Modifique los detalles del inmueble y guarde los cambios.</p>
        </div>
        ...
        <div class="form-container">
            ...
            <?php if (isset($_GET['error'])): ?>
                <div style="background-color: rgba(239, 68, 68, 0.15); color: #f87171; padding: 12px; border-radius: 8px; margin-bottom: 24px; border: 1px solid rgba(239, 68, 68, 0.3);">
                    Error al actualizar el inmueble. Por favor, verifique los datos.
                </div>
            <?php endif; ?>

            <form action="<?php echo URL_ROOT; ?>/admin/inmuebles/update" method="POST">
                ...
                <div class="form-row">
                    <div class="form-group">
                        ...
                        <select name="tipo" id="tipo" class="form-control" required>
                            ...
                            <option value="bodega" <?php echo $inmueble['tipo'] == 'bodega' ? 'selected' : ''; ?>>Bodega</option>
                            <option value="lote" <?php echo $inmueble['tipo'] == 'lote' ? 'selected' : ''; ?>>Lote / Terreno</option>
                        </select>
                    </div>
                    <div class="form-group">
                        <label for="direccion">Dirección Completa</label>
                        <input type="text" name="direccion" id="direccion" class="form-control" required placeholder="Ej: Calle 100 #15-25, Bogotá" value="<?php echo htmlspecialchars($inmueble['direccion']); ?>">
                    </div>
                </div>
                ...
                <div class="form-row">
                    <div class="form-group">
                        ...
                        <input type="number" name="estrato" id="estrato" class="form-control" min="0" max="6" value="<?php echo $inmueble['estrato']; ?>">
                    </div>
                    <div class="form-group">
                        <label for="area_m2">Área (m²)</label>
                        <input type="number" step="0.01" name="area_m2" id="area_m2" class="form-control" required placeholder="Ej: 120.5" value="<?php echo $inmueble['area_m2']; ?>">
                    </div>
                </div>
                ...
                <div class="form-row">
                    <div class="form-group">
                        ...
                        <input type="number" name="habitaciones" id="habitaciones" class="form-control" min="0" value="<?php echo $inmueble['habitaciones']; ?>">
                    </div>
                    <div class="form-group">
                        <label for="banos">Baños</label>
                        <input type="number" name="banos" id="banos" class="form-control" min="0" value="<?php echo $inmueble['banos']; ?>">
                    </div>
                </div>
                ...
                <div class="form-row">
                    <div class="form-group">
                        ...
                        <select name="tipo_operacion" id="tipo_operacion" class="form-control" required>
                            <option value="venta" <?php echo ($inmueble['tipo_operacion'] ?? 'venta') == 'venta' ? 'selected' : ''; ?>>Venta</option>
                            <option value="arriendo" <?php echo ($inmueble['tipo_operacion'] ?? 'venta') == 'arriendo' ? 'selected' : ''; ?>>Arriendo</option>
                        </select>
                    </div>
                    <div class="form-group">
                        <label for="precio">Precio Final ($)</label>
                        <input type="number" name="precio" id="precio" class="form-control" required placeholder="Ej: 350000000" value="<?php echo $inmueble['precio']; ?>">
                    </div>
                </div>
                ...
                <div class="form-row">
                    <div class="form-group">
                        ...
                        <select name="estado_inmueble" id="estado_inmueble" class="form-control" required>
                            ...
                            <option value="mantenimiento" <?php echo $inmueble['estado'] == 'mantenimiento' ? 'selected' : ''; ?>>En Mantenimiento</option>
                            ...
                            <option value="reservado" <?php echo $inmueble['estado'] == 'reservado' ? 'selected' : ''; ?>>Reservado</option>
                        </select>
                    </div>
                    <div class="form-group">
                        ...
                        <select name="estado_inventario" id="estado_inventario" class="form-control" required>
                            <option value="activo" <?php echo ($inmueble['estado_inventario'] ?? 'activo') == 'activo' ? 'selected' : ''; ?>>Activo (Visible)</option>
                            <option value="pausado" <?php echo ($inmueble['estado_inventario'] ?? 'activo') == 'pausado' ? 'selected' : ''; ?>>Pausado (Oculto)</option>
                        </select>
                    </div>
                </div>

                <h3 class="form-section-title">3. Asignación y Ficha Técnica</h3>
                <div class="form-group">
                    ...
                    <select name="id_agente" id="id_agente" class="form-control">
                        ...
                        <?php if (isset($agentes) && !empty($agentes)): ?>
                            <?php foreach ($agentes as $agente): ?>
                                <option value="<?php echo $agente['id_agente']; ?>" <?php echo $inmueble['id_agente'] == $agente['id_agente'] ? 'selected' : ''; ?>>
                ...
                <div class="form-group">
                    ...
                    <textarea name="descripcion" id="descripcion" rows="5" class="form-control" required placeholder="Escriba aquí los detalles principales del inmueble..."><?php echo htmlspecialchars($inmueble['descripcion']); ?></textarea>
                </div>

                <div class="form-group" style="margin-top: 32px;">
                    <button type="submit" class="btn-submit">Actualizar Inmueble</button>
                </div>
            </form>
        </div>
    </main>
